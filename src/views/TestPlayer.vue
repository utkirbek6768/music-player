    ...
    <div class="wrapper" id="app">
      <div class="player">
        <div class="player__top">
          <div style="border: 1px solid red" class="player-cover">
            <transition-group :name="transitionName">
              <div
                class="player-cover__item"
                v-for="(track, index) in tracks"
                v-if="index + 1 !== currentTrackIndex"
                :key="index"
                :style="{ backgroundImage: `url(${track.cover})` }"
              >
                {{ track }}
              </div>
              <h1 style="color: red">index{{ index }}</h1>
              <h1 style="color: red">
        ...
        <div style="border: 1px solid red" class="progress" ref="progress">
